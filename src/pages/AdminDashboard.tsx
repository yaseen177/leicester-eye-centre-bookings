...
export default function AdminDashboard() {
  ...
  const handleSendDispenseVoucher = async (docId: string, collectionName: string, email: string, name: string, isClinic: boolean) => {
    ...
    const openingText = isClinic 
      ? "Thank you for attending your recent sight test with us! We noticed your prescription has changed but you haven't chosen your new glasses yet."
      : "Thank you for popping in recently for a quote on your new glasses! We would love to look after your vision.";

    // Beautifully formatted custom HTML email template
    ...
    <head>
        ...
        <title>Your £10 Gift from The Eye Centre</title>
    </head>
    <body style="margin: 0; padding: 0; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; background-color: #f4f7f6; color: #333333;">
        <center style="width: 100%; table-layout: fixed; background-color: #f4f7f6; padding: 40px 0;">
            <table width="100%" style="background-color: #ffffff; margin: 0 auto; width: 100%; max-width: 600px; border-spacing: 0; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 15px rgba(0,0,0,0.05);">
                
                <tr>
                    <td style="background-color: #ffffff; padding: 30px 20px; text-align: center; border-bottom: 4px solid #3F9185;">
                        <img src="https://img1.wsimg.com/isteam/ip/297dd456-b70f-4175-b7e6-7f1aabf6e6b3/blob-0f9c396.png/:/rs=w:630,h:126,cg:true,m/cr=w:630,h:126/qt=q:95" alt="The Eye Centre Logo" style="max-width: 250px; height: auto; display: inline-block;">
                    </td>
                </tr>

                <tr>
                    <td style="padding: 40px 35px; line-height: 1.6; font-size: 16px; color: #4a5568;">
                        <h2 style="color: #3F9185; font-size: 24px; margin-top: 0; font-weight: 800; text-transform: uppercase; letter-spacing: 1px; text-align: center;">A Gift For You</h2>
                        <p>Dear ${name.split(' ')[0]},</p>
                        <p>${openingText}</p>
                        <p>As a gesture of goodwill, please enjoy £10 off any complete pair of prescription glasses or sunglasses. Whether you are looking for an everyday essential or a luxury upgrade, we have something perfect for you.</p>

                        <div style="background-color: #f0fdfa; border: 2px dashed #3F9185; border-radius: 12px; padding: 30px 25px; margin: 35px 0; text-align: center;">
                            <p style="margin: 0; font-size: 14px; font-weight: bold; color: #0f766e; text-transform: uppercase; letter-spacing: 2px;">Exclusive Voucher</p>
                            <h3 style="color: #3F9185; margin: 15px 0; font-size: 42px; font-weight: 900; letter-spacing: 1px;">£10 OFF</h3>
                            <p style="margin: 0; font-size: 13px; color: #115e59; font-weight: bold;">Valid until: <span style="color: #e11d48;">${formattedExpiryDate}</span></p>
                            <p style="margin: 15px 0 0 0; font-size: 12px; color: #0f766e;">Simply show this email to our team in-store to claim your discount.</p>
                        </div>
                        
                        <p style="text-align: center; margin-bottom: 30px;">Pop in any time during our opening hours—no appointment needed for browsing!</p>
                    </td>
                </tr>

                <tr>
                    <td style="padding: 30px 35px; background-color: #f8fafc; border-top: 1px solid #edf2f7;">
                        <h3 style="color: #1e293b; font-size: 16px; margin-top: 0; margin-bottom: 20px; font-weight: 800; text-transform: uppercase; letter-spacing: 1px; text-align: center;">Discover Our Designer Collections</h3>
                        
                        <div style="text-align: center; margin-bottom: 30px;">
                           <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/4/4e/Ray-Ban_logo.svg/2560px-Ray-Ban_logo.svg.png" alt="Ray-Ban" style="height: 35px; width: auto; margin: 0 15px 15px 15px; display: inline-block; filter: grayscale(100%); opacity: 0.7;">
                           <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/8/87/Tom_Ford_Logo.svg/2560px-Tom_Ford_Logo.svg.png" alt="Tom Ford" style="height: 25px; width: auto; margin: 0 15px 15px 15px; display: inline-block; filter: grayscale(100%); opacity: 0.7;">
                           <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/7/7b/Mulberry_Logo.svg/2560px-Mulberry_Logo.svg.png" alt="Mulberry" style="height: 25px; width: auto; margin: 0 15px 15px 15px; display: inline-block; filter: grayscale(100%); opacity: 0.7;">
                        </div>

                        <div style="background-color: #ffffff; border: 1px solid #e2e8f0; border-radius: 12px; padding: 25px; text-align: center; box-shadow: 0 2px 5px rgba(0,0,0,0.02);">
                            <p style="margin: 0 0 15px 0; font-size: 13px; font-weight: bold; color: #64748b; text-transform: uppercase; letter-spacing: 1px;">Why not shop our exclusive own-brand?</p>
                            <img src="data:image/png;base64," alt="Vanity Eyewear" style="max-width: 140px; height: auto; display: inline-block;">
                            <p style="margin: 15px 0 0 0; font-size: 14px; color: #4a5568; line-height: 1.5;">Created by The Eye Centre especially for you. Discover our stunning, affordable range of frames designed with exceptional quality and comfort in mind.</p>
                        </div>
                    </td>
                </tr>

                <tr>
                    <td style="background-color: #1e293b; padding: 30px; text-align: center; font-size: 12px; color: #94a3b8;">
                        <p style="color: #ffffff; font-size: 14px; margin-top: 0;"><strong>The Eye Centre, Leicester</strong></p>
                        <p>56 High Street, Leicester LE1 5YN</p>
                        <p>0116 253 2788</p>
                        <p style="margin-top: 20px; font-size: 10px; color: #64748b;">*Terms and conditions apply. £10 discount applies to a complete pair of prescription glasses or sunglasses. Cannot be used in conjunction with any other offer. Voucher expires 7 days from the date of this email.</p>
                    </td>
                </tr>
            </table>
        </center>
    ...
    try {
      const res = await fetch("https://twilio.yaseen-hussain18.workers.dev/", {
        ...
        body: JSON.stringify({
          ...
          // Send the raw custom HTML instead of relying on a Brevo template ID
